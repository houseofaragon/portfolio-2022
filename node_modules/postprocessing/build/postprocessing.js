...
var POSTPROCESSING = (() => {
  ...
  var import_three36 = __toModule(__require("three"));

  // src/passes/AdaptiveLuminancePass.js
  var import_three21 = __toModule(__require("three"));
  ...
  var MaskMaterial = class extends import_three15.ShaderMaterial {
    ...
    set maskTexture(value) {
      ...
      if (value.type !== import_three15.UnsignedByteType) {
  ...
  var import_three18 = __toModule(__require("three"));
  ...
  // src/passes/Pass.js
  var import_three19 = __toModule(__require("three"));
  ...
  var import_three20 = __toModule(__require("three"));
  var SavePass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three20.UnsignedByteType) {
          const material = this.getFullscreenMaterial();
  ...
  var import_three23 = __toModule(__require("three"));

  // src/core/Resizer.js
  var import_three22 = __toModule(__require("three"));
  var AUTO_SIZE = -1;
  var Resizer = class {
  ...
  var import_three24 = __toModule(__require("three"));
  ...
  var import_three26 = __toModule(__require("three"));

  // src/core/OverrideMaterialManager.js
  var import_three25 = __toModule(__require("three"));
  ...
  var import_three27 = __toModule(__require("three"));
  ...
  var import_three29 = __toModule(__require("three"));

  // src/passes/DepthSavePass.js
  var import_three28 = __toModule(__require("three"));
  ...
  function unpackRGBAToDepth(packedDepth) {
    return (packedDepth[0] * unpackFactors[0] + packedDepth[1] * unpackFactors[1] + packedDepth[2] * unpackFactors[2] + packedDepth[3] * unpackFactors[3]) / 256;
  }
  ...
  var import_three32 = __toModule(__require("three"));
  ...
  var import_three30 = __toModule(__require("three"));
  ...
  var import_three31 = __toModule(__require("three"));
  ...
  var import_three33 = __toModule(__require("three"));
  ...
  var import_three34 = __toModule(__require("three"));
  ...
  var import_three35 = __toModule(__require("three"));
  ...
  var EffectComposer = class {
    ...
    get multisampling() {
      return this.inputBuffer instanceof import_three36.WebGLMultisampleRenderTarget ? this.inputBuffer.samples : 0;
    }
    ...
    replaceRenderer(renderer, updateDOM = true) {
      ...
      if (oldRenderer !== null && oldRenderer !== renderer) {
        const oldSize = oldRenderer.getSize(new import_three36.Vector2());
        const newSize = renderer.getSize(new import_three36.Vector2());
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const context = renderer.getContext();
      const size = renderer.getDrawingBufferSize(new import_three36.Vector2());
      const alpha = this.alpha || context.getContextAttributes().alpha;
      const options = {
        format: !alpha && type === import_three36.UnsignedByteType ? import_three36.RGBFormat : import_three36.RGBAFormat,
      ...
      const renderTarget = multisampling > 0 ? new import_three36.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three36.WebGLRenderTarget(size.width, size.height, options);
      if (multisampling > 0) {
  ...
  var import_three37 = __toModule(__require("three"));
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      super("BloomEffect", shader_default46, {
        blendFunction,
        uniforms: new Map([
          ["map", new import_three37.Uniform(null)],
          ["intensity", new import_three37.Uniform(intensity)]
        ])
      });
    ...
    get distinction() {
      console.warn(this.name, "The distinction field has been removed, use .threshold and .smoothing instead.");
      return 1;
    }
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three37.UnsignedByteType) {
        this.renderTarget.texture.format = import_three37.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
      }
  ...
  var import_three38 = __toModule(__require("three"));
  ...
  var BokehEffect = class extends Effect {
    constructor({
      ...
      super("BokehEffect", shader_default47, {
        ...
        uniforms: new Map([
          ["focus", new import_three38.Uniform(focus)],
          ["dof", new import_three38.Uniform(dof)],
          ["aperture", new import_three38.Uniform(aperture)],
          ["maxBlur", new import_three38.Uniform(maxBlur)]
        ])
      });
    }
  };
  ...
  var import_three39 = __toModule(__require("three"));
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({
      ...
      super("BrightnessContrastEffect", shader_default48, {
        blendFunction,
        uniforms: new Map([
          ["brightness", new import_three39.Uniform(brightness)],
          ["contrast", new import_three39.Uniform(contrast)]
        ])
      });
    }
  };
  ...
  var import_three40 = __toModule(__require("three"));
  ...
  var ColorDepthEffect = class extends Effect {
    constructor({
      ...
      super("ColorDepthEffect", shader_default50, {
        blendFunction,
        uniforms: new Map([
          ["factor", new import_three40.Uniform(1)]
        ])
      });
      this.bits = 0;
  ...
  var import_three41 = __toModule(__require("three"));
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({
      blendFunction = BlendFunction.NORMAL,
      offset = new import_three41.Vector2(1e-3, 5e-4)
    } = {}) {
      super("ChromaticAberrationEffect", shader_default51, {
        ...
        uniforms: new Map([
          ["offset", new import_three41.Uniform(offset)]
        ])
      });
    }
    get offset() {
  ...
  var import_three42 = __toModule(__require("three"));
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", shader_default54, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["nearColorBuffer", new import_three42.Uniform(null)],
          ["farColorBuffer", new import_three42.Uniform(null)],
          ["nearCoCBuffer", new import_three42.Uniform(null)],
          ["scale", new import_three42.Uniform(1)]
        ])
      });
      this.camera = camera;
      this.renderTarget = new import_three42.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetCoC.texture.format = import_three42.RGBFormat;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.blurPass.initialize(renderer, alpha, import_three42.UnsignedByteType);
      if (!alpha && frameBufferType === import_three42.UnsignedByteType) {
        this.renderTargetNear.texture.type = import_three42.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
  ...
  var import_three43 = __toModule(__require("three"));
  ...
  var DotScreenEffect = class extends Effect {
    constructor({
      ...
      super("DotScreenEffect", shader_default55, {
        blendFunction,
        uniforms: new Map([
          ["angle", new import_three43.Uniform(new import_three43.Vector2())],
          ["scale", new import_three43.Uniform(scale)]
        ])
      });
      this.setAngle(angle);
    }
  ...
  var import_three44 = __toModule(__require("three"));
  ...
  var GammaCorrectionEffect = class extends Effect {
    constructor({
      ...
      super("GammaCorrectionEffect", shader_default56, {
        blendFunction,
        uniforms: new Map([
          ["gamma", new import_three44.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  var import_three46 = __toModule(__require("three"));

  // src/images/textures/NoiseTexture.js
  var import_three45 = __toModule(__require("three"));
  function getNoise(size, format, type) {
    const channels = new Map([
      [import_three45.LuminanceFormat, 1],
      [import_three45.RedFormat, 1],
      [import_three45.RGFormat, 2],
      [import_three45.RGBFormat, 3],
      [import_three45.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three45.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three45.DataTexture {
    constructor(width, height, format = import_three45.LuminanceFormat, type = import_three45.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      delay = new import_three46.Vector2(1.5, 3.5),
      duration = new import_three46.Vector2(0.6, 1),
      strength = new import_three46.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", shader_default57, {
        blendFunction,
        uniforms: new Map([
          ["perturbationMap", new import_three46.Uniform(null)],
          ["columns", new import_three46.Uniform(columns)],
          ["active", new import_three46.Uniform(false)],
          ["random", new import_three46.Uniform(1)],
          ["seed", new import_three46.Uniform(new import_three46.Vector2())],
          ["distortion", new import_three46.Uniform(new import_three46.Vector2())]
        ])
      });
      this.setPerturbationMap(perturbationMap === null ? this.generatePerturbationMap(dtSize) : perturbationMap);
      this.delay = delay;
      this.duration = duration;
      this.breakPoint = new import_three46.Vector2(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
      this.time = 0;
    ...
    setPerturbationMap(map) {
      ...
      map.minFilter = map.magFilter = import_three46.NearestFilter;
      map.wrapS = map.wrapT = import_three46.RepeatWrapping;
      map.generateMipmaps = false;
      this.uniforms.get("perturbationMap").value = map;
    }
    generatePerturbationMap(size = 64) {
      const map = new NoiseTexture(size, size, import_three46.RGBFormat);
      map.name = tag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  var import_three47 = __toModule(__require("three"));
  ...
  // src/effects/GodRaysEffect.js
  var v = new import_three47.Vector3();
  var m = new import_three47.Matrix4();
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", shader_default58, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["map", new import_three47.Uniform(null)]
        ])
      });
      this.camera = camera;
      ...
      this.lightScene = new import_three47.Scene();
      this.screenPosition = new import_three47.Vector2();
      this.renderTargetA = new import_three47.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetLight.depthTexture = new import_three47.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.getClearPass().overrideClearColor = new import_three47.Color(0);
    ...
    setDepthTexture(depthTexture, depthPacking = import_three47.BasicDepthPacking) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three47.UnsignedByteType) {
        this.renderTargetA.texture.format = import_three47.RGBFormat;
        this.renderTargetB.texture.format = import_three47.RGBFormat;
        this.renderTargetLight.texture.format = import_three47.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetA.texture.type = frameBufferType;
        this.renderTargetB.texture.type = frameBufferType;
  ...
  var import_three48 = __toModule(__require("three"));
  ...
  var GridEffect = class extends Effect {
    constructor({
      ...
      super("GridEffect", shader_default59, {
        blendFunction,
        uniforms: new Map([
          ["scale", new import_three48.Uniform(new import_three48.Vector2())],
          ["lineWidth", new import_three48.Uniform(lineWidth)]
        ])
      });
  ...
  var import_three49 = __toModule(__require("three"));
  ...
  var HueSaturationEffect = class extends Effect {
    constructor({
      ...
      super("HueSaturationEffect", shader_default60, {
        blendFunction,
        uniforms: new Map([
          ["hue", new import_three49.Uniform(new import_three49.Vector3())],
          ["saturation", new import_three49.Uniform(saturation)]
        ])
      });
      this.setHue(hue);
    }
  ...
  var import_three51 = __toModule(__require("three"));

  // src/images/textures/LookupTexture3D.js
  var import_three50 = __toModule(__require("three"));
  ...
  var LookupTexture3D = class extends import_three50.DataTexture3D {
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three50.FloatType || this.type !== import_three50.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== import_three50.RGBFormat || this.format !== import_three50.RGBFormat) {
    ...
    convertToUint8() {
      if (this.type === import_three50.FloatType) {
        ...
        this.type = import_three50.UnsignedByteType;
        this.needsUpdate = true;
      }
      return this;
    }
    convertToFloat() {
      if (this.type === import_three50.UnsignedByteType) {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three50.FloatType) {
        const stride = this.format === import_three50.RGBAFormat ? 4 : 3;
        for (let i = 0, l = data.length; i < l; i += stride) {
          c.fromArray(data, i).convertLinearToSRGB().toArray(data, i);
        }
        this.encoding = import_three50.sRGBEncoding;
        this.needsUpdate = true;
      } else {
    ...
    convertToRGBA() {
      if (this.format === import_three50.RGBFormat) {
        ...
        this.format = import_three50.RGBAFormat;
        this.needsUpdate = true;
      }
      return this;
    }
    toDataTexture() {
      ...
      const texture = new import_three50.DataTexture(this.image.data, width, height);
      texture.name = this.name;
      texture.type = this.type;
      texture.format = this.format;
      texture.encoding = this.encoding;
      texture.minFilter = import_three50.LinearFilter;
      texture.magFilter = import_three50.LinearFilter;
  ...
  var LUTEffect = class extends Effect {
    constructor(lut, {
      ...
      super("LUTEffect", shader_default61, {
        blendFunction,
        uniforms: new Map([
          ["lut", new import_three51.Uniform(null)],
          ["scale", new import_three51.Uniform(new import_three51.Vector3())],
          ["offset", new import_three51.Uniform(new import_three51.Vector3())],
          ["domainMin", new import_three51.Uniform(null)],
          ["domainMax", new import_three51.Uniform(null)]
        ])
      });
      this.tetrahedralInterpolation = tetrahedralInterpolation;
      this.inputEncoding = import_three51.sRGBEncoding;
      this.outputEncoding = this.inputEncoding;
      this.setInputEncoding(import_three51.sRGBEncoding);
      this.setLUT(lut);
    }
    getOutputEncoding() {
    ...
    setInputEncoding(value) {
      ...
      switch (value) {
        case import_three51.sRGBEncoding:
          defines.set("linearToInputTexel(texel)", "LinearTosRGB(texel)");
          break;
        case import_three51.LinearEncoding:
      ...
      if (lut !== null) {
        this.outputEncoding = lut.encoding === import_three51.LinearEncoding ? value : lut.encoding;
    ...
    setLUT(lut) {
      ...
      if (this.getLUT() !== lut) {
        ...
        if (lut.type === import_three51.FloatType || lut.type === import_three51.HalfFloatType) {
          defines.set("LUT_PRECISION_HIGH", "1");
        }
        if (image.width > image.height) {
          defines.set("LUT_STRIP_HORIZONTAL", "1");
        } else if (lut instanceof import_three51.DataTexture3D) {
    ...
    configureTetrahedralInterpolation() {
      const lut = this.getLUT();
      lut.minFilter = import_three51.LinearFilter;
      lut.magFilter = import_three51.LinearFilter;
      this.defines.delete("TETRAHEDRAL_INTERPOLATION");
      if (this.tetrahedralInterpolation && lut !== null) {
        if (lut instanceof import_three51.DataTexture3D) {
          this.defines.set("TETRAHEDRAL_INTERPOLATION", "1");
          lut.minFilter = import_three51.NearestFilter;
          lut.magFilter = import_three51.NearestFilter;
        } else {
  ...
  var import_three52 = __toModule(__require("three"));
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      super("OutlineEffect", shader_default63, {
        uniforms: new Map([
          ["maskTexture", new import_three52.Uniform(null)],
          ["edgeTexture", new import_three52.Uniform(null)],
          ["edgeStrength", new import_three52.Uniform(edgeStrength)],
          ["visibleEdgeColor", new import_three52.Uniform(new import_three52.Color(visibleEdgeColor))],
          ["hiddenEdgeColor", new import_three52.Uniform(new import_three52.Color(hiddenEdgeColor))],
          ["pulse", new import_three52.Uniform(1)],
          ["patternScale", new import_three52.Uniform(1)],
          ["patternTexture", new import_three52.Uniform(null)]
        ])
      });
      ...
      this.scene = scene;
      this.camera = camera;
      this.renderTargetMask = new import_three52.WebGLRenderTarget(1, 1, {
        minFilter: import_three52.LinearFilter,
        magFilter: import_three52.LinearFilter,
        stencilBuffer: false,
        format: import_three52.RGBFormat
      });
      ...
      this.clearPass = new ClearPass();
      this.clearPass.overrideClearColor = new import_three52.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.depthPass = new DepthPass(scene, camera);
      this.maskPass = new RenderPass(scene, camera, new DepthComparisonMaterial(this.depthPass.texture, camera));
      const clearPass = this.maskPass.getClearPass();
      clearPass.overrideClearColor = new import_three52.Color(16777215);
      clearPass.overrideClearAlpha = 1;
    ...
    setPatternTexture(texture) {
      if (texture !== null) {
        texture.wrapS = texture.wrapT = import_three52.RepeatWrapping;
    ...
    initialize(renderer, alpha, frameBufferType) {
      this.blurPass.initialize(renderer, alpha, import_three52.UnsignedByteType);
      if (frameBufferType !== void 0) {
  ...
  var import_three53 = __toModule(__require("three"));
  ...
  var PixelationEffect = class extends Effect {
    constructor(granularity = 30) {
      super("PixelationEffect", shader_default65, {
        uniforms: new Map([
          ["active", new import_three53.Uniform(false)],
          ["d", new import_three53.Uniform(new import_three53.Vector2())]
        ])
      });
      this.resolution = new import_three53.Vector2();
  ...
  var import_three54 = __toModule(__require("three"));
  ...
  var RealisticBokehEffect = class extends Effect {
    constructor({
      ...
      super("RealisticBokehEffect", shader_default66, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["focus", new import_three54.Uniform(focus)],
          ["focalLength", new import_three54.Uniform(focalLength)],
          ["fStop", new import_three54.Uniform(fStop)],
          ["luminanceThreshold", new import_three54.Uniform(luminanceThreshold)],
          ["luminanceGain", new import_three54.Uniform(luminanceGain)],
          ["bias", new import_three54.Uniform(bias)],
          ["fringe", new import_three54.Uniform(fringe)],
          ["maxBlur", new import_three54.Uniform(maxBlur)],
          ["dof", new import_three54.Uniform(null)]
        ])
      });
      this.rings = rings;
      this.samples = samples;
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new import_three54.Vector4(0.2, 1, 0.2, 2);
        } else {
  ...
  var import_three55 = __toModule(__require("three"));
  ...
  var ScanlineEffect = class extends Effect {
    constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25 } = {}) {
      super("ScanlineEffect", shader_default67, {
        blendFunction,
        uniforms: new Map([
          ["count", new import_three55.Uniform(0)]
        ])
      });
  ...
  var import_three56 = __toModule(__require("three"));
  ...
  var v2 = new import_three56.Vector3();
  var ab = new import_three56.Vector3();
  var ShockWaveEffect = class extends Effect {
    constructor(camera, epicenter = new import_three56.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shader_default68, {
        ...
        uniforms: new Map([
          ...
          ["center", new import_three56.Uniform(new import_three56.Vector2(0.5, 0.5))],
          ["cameraDistance", new import_three56.Uniform(1)],
          ["size", new import_three56.Uniform(1)],
          ["radius", new import_three56.Uniform(-waveSize)],
          ["maxRadius", new import_three56.Uniform(maxRadius)],
          ["waveSize", new import_three56.Uniform(waveSize)],
          ["amplitude", new import_three56.Uniform(amplitude)]
        ])
      });
      this.camera = camera;
  ...
  var import_three57 = __toModule(__require("three"));
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      depthMaskMaterial.defines.DEPTH_PACKING_1 = import_three57.RGBADepthPacking.toFixed(0);
      depthMaskMaterial.setDepthMode(import_three57.EqualDepth);
      this.renderTargetMasked = new import_three57.WebGLRenderTarget(1, 1, {
        minFilter: import_three57.LinearFilter,
    ...
    get inverted() {
      return this.depthMaskMaterial.getDepthMode() === import_three57.NotEqualDepth;
    }
    set inverted(value) {
      this.depthMaskMaterial.setDepthMode(value ? import_three57.NotEqualDepth : import_three57.EqualDepth);
    }
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.depthPass.initialize(renderer, alpha, frameBufferType);
      this.depthMaskPass.initialize(renderer, alpha, frameBufferType);
      if (!alpha && frameBufferType === import_three57.UnsignedByteType) {
        this.renderTargetMasked.texture.format = import_three57.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetMasked.texture.type = frameBufferType;
      }
  ...
  var import_three58 = __toModule(__require("three"));
  ...
  var import_three59 = __toModule(__require("three"));
  ...
  var SMAAEffect = class extends Effect {
    constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
      super("SMAAEffect", shader_default71, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["weightMap", new import_three59.Uniform(null)]
        ])
      });
      this.renderTargetEdges = new import_three59.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetWeights.texture.format = import_three59.RGBAFormat;
      this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three59.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new import_three59.Vector2(), edgeDetectionMode));
      this.weightsPass = new ShaderPass(new SMAAWeightsMaterial());
      const searchTexture = new import_three59.Texture(searchImage);
      searchTexture.name = "SMAA.Search";
      searchTexture.magFilter = import_three59.NearestFilter;
      searchTexture.minFilter = import_three59.NearestFilter;
      searchTexture.format = import_three59.RGBAFormat;
      searchTexture.generateMipmaps = false;
      searchTexture.needsUpdate = true;
      searchTexture.flipY = true;
      const areaTexture = new import_three59.Texture(areaImage);
      areaTexture.name = "SMAA.Area";
      areaTexture.magFilter = import_three59.LinearFilter;
      areaTexture.minFilter = import_three59.LinearFilter;
      areaTexture.format = import_three59.RGBAFormat;
  ...
  var import_three60 = __toModule(__require("three"));
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", shader_default73, {
        ...
        uniforms: new Map([
          ["aoBuffer", new import_three60.Uniform(null)],
          ["normalDepthBuffer", new import_three60.Uniform(null)],
          ["luminanceInfluence", new import_three60.Uniform(luminanceInfluence)],
          ["color", new import_three60.Uniform(null)],
          ["scale", new import_three60.Uniform(0)]
        ])
      });
      this.renderTargetAO = new import_three60.WebGLRenderTarget(1, 1, {
        minFilter: import_three60.LinearFilter,
        magFilter: import_three60.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three60.RGBFormat
      });
      ...
      this.ssaoPass = new ShaderPass((() => {
        ...
        noiseTexture.wrapS = noiseTexture.wrapT = import_three60.RepeatWrapping;
    ...
    set color(value) {
      ...
      if (value !== null) {
        if (defines.has("COLORIZE")) {
          ...
          uniforms.get("color").value = new import_three60.Color(value);
          this.setChanged();
        }
    ...
    setDepthTexture(depthTexture, depthPacking = import_three60.BasicDepthPacking) {
      const material = this.ssaoMaterial;
  ...
  var import_three61 = __toModule(__require("three"));
    ...
    constructor({
      ...
      super("TextureEffect", shader_default74, {
        ...
        uniforms: new Map([
          ...
          ["scale", new import_three61.Uniform(1)],
          ["uvTransform", new import_three61.Uniform(null)]
        ])
      });
      ...
      if (currentTexture !== value) {
        ...
        if (value !== null) {
          switch (value.encoding) {
            case import_three61.sRGBEncoding:
              this.defines.set("texelToLinear(texel)", "sRGBToLinear(texel)");
              break;
            case import_three61.LinearEncoding:
          ...
          if (value.type !== import_three61.UnsignedByteType) {
    ...
    set uvTransform(value) {
      if (this.uvTransform !== value) {
        if (value) {
          ...
          this.uniforms.get("uvTransform").value = new import_three61.Matrix3();
          this.setVertexShader(shader_default75);
        } else {
  ...
  var import_three62 = __toModule(__require("three"));
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", shader_default76, {
        blendFunction,
        uniforms: new Map([
          ["luminanceBuffer", new import_three62.Uniform(null)],
          ["maxLuminance", new import_three62.Uniform(maxLuminance)],
          ["whitePoint", new import_three62.Uniform(whitePoint)],
          ["middleGrey", new import_three62.Uniform(middleGrey)],
          ["averageLuminance", new import_three62.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three62.WebGLRenderTarget(1, 1, {
        minFilter: import_three62.LinearMipmapLinearFilter !== void 0 ? import_three62.LinearMipmapLinearFilter : import_three62.LinearMipMapLinearFilter,
        magFilter: import_three62.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
        format: import_three62.RGBFormat
      });
  ...
  var import_three63 = __toModule(__require("three"));
  ...
  var VignetteEffect = class extends Effect {
    constructor(options = {}) {
      ...
      super("VignetteEffect", shader_default77, {
        ...
        uniforms: new Map([
          ["offset", new import_three63.Uniform(settings.offset)],
          ["darkness", new import_three63.Uniform(settings.darkness)]
        ])
      });
  ...
  var import_three64 = __toModule(__require("three"));
    ...
    generate() {
      ...
      return promise.then((urls) => {
        return new Promise((resolve, reject) => {
          ...
          const manager = new import_three64.LoadingManager();
  ...
  var import_three65 = __toModule(__require("three"));
  ...
  var import_three66 = __toModule(__require("three"));
  var LUTCubeLoader = class extends import_three66.Loader {
    ...
    parse(input) {
      ...
      const lut = new LookupTexture3D(data, size, size, size);
      lut.encoding = import_three66.sRGBEncoding;
  ...
  var import_three67 = __toModule(__require("three"));
